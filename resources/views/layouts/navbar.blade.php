...
<a style="float:right" class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown"
...
<ul>
                    ...
                    @auth
                            ...
                            <li> <a class="dropdown-item"  href="{{ route('myAccount') }}"> <i class="fa-solid fa-user"></i> {{ trans('mainpage.my_account') }}</a>
                            </li>
                            <li> <a class="dropdown-item"  href="{{ route('myEq') }}"> <i class="fa-solid fa-user"></i> {{ trans('mainpage.equipment') }}</a>
                            </li>                               
                            <li> <a class="dropdown-item"  href="{{ route('passport') }}"><i class="fa-solid fa-file-pdf"></i> {{ trans('mainpage.passport') }}</a>
                            </li>
                            <li> <a class="dropdown-item" href="{{ route('image.choose') }}"><i class="fa-solid fa-images"></i> {{ trans('mainpage.add_photo') }}</a>
                            </li>
                            <li><a class="dropdown-item"  href="{{ route('image.cancel') }}"> <i class="fa-solid fa-folder-minus"></i> {{ trans('mainpage.cancel_photo') }} </a>
                            </li>
                            <li> <a class="dropdown-item"  href="{{ route('signout') }}"> <i class="fa-solid fa-lock"></i> {{ trans('mainpage.logout') }} </a>
</li>
                        </li>
                    @endauth
