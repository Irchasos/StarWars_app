            ...
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <img class="rounded-circle mt-5" width="150px"
                        ...
                        class="font-weight-bold">{{$user->name}}{{$user->id}}</span><span
                ...
                <div class="p-3 py-5">
                    ...
                    <form method="POST" action="{{ route('change.data') }}">
                        ...
                        <div class="col-md-12"><label class="labels">Change Name</label>
                            <input type="text" name="new_name" class="form-control" placeholder="{{$user->name}}" value="{{$user->name}}">
                        </div>
                        ...
                        <div class="col-md-12"><label class="labels">Your tasks</label>
                            @foreach ($permissions as $permission)
                                <input type="text" class="form-control" disabled placeholder="  {{$permission->name}}"
                                       value="">
                            @endforeach
                        </div>
                    </div>
