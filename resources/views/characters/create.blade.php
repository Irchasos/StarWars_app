    ...
    @endif
            ...
            <div class="col-md-6 right-grid">
                <div class="right-top">
                        ...
                        <button class="btn btn btn-lg btn-warning"><a href="{{ route('characters') }}">View All characters </a><i class="fa-solid fa-person-chalkboard"></i></button>
                    ...
                    <form action="{{ route('characters.store') }}" method="POST">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <button type="submit" class="btn btn-lg btn-primary"> <i class="fa-regular fa-floppy-disk"></i></button>
                        </div>
                    </form>
                </div>
