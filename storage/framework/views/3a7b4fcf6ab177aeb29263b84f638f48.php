                            ...
                            <div class="col-12">
                                <form action="<?php echo e(route('characters')); ?>" method="GET" role="search">
                                    <div class="input-group">
                                        <input value="<?php echo e(Request::get('term')); ?>" type="text" class="form-control" name="term" placeholder="<?php echo e(trans('characters_views.all_of_characters_or_type_and_searchenter')); ?>" id="term">
                                        <input value="<?php echo e(Request::get('homeworld')); ?>" type="text" class="form-control" name="homeworld" placeholder="<?php echo e(trans('characters_views.homeworld')); ?>" id="homeworld">
                                        ...
                                        <td>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit character in base')): ?>
                                                <form action="<?php echo e(route('characters.destroy',$character->id)); ?>" method="POST">
                                                    <a class="btn btn-block btn-info mb-1" href="<?php echo e(route('characters.edit',$character->id)); ?>"><i class="fa-solid fa-user-pen"></i></a>
                                                    <?php echo csrf_field(); ?>
