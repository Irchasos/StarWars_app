...
<div class="header" id="head">
    <nav>
        <ul>
            ...
            <li><a href="<?php echo e(route('games')); ?>" class="scroll"><?php echo e(trans('mainpage.games')); ?></a></li>
        </ul>
    </nav>

</div>
</div><?php /**PATH /var/www/html/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>